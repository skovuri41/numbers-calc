...
(comment (calc-num " a ")
         (calc-num "a")
         (get-number " shyam sunder k")
         (get-number " shyam sunder")
         (get-number " shyam kovuri")
         (get-number " shyam k")
         ;; (get-number "shyam")
         (get-number "krishna advaita")
         (get-number "paresh aditya kovuri")
         (get-number "paresh aditya")
         (get-number "paresh kovuri")
         (get-number "paresh")
         (get-number "vladimirputin")
         (get-number " joseph stalin ")
         (get-number "shyamkovuri3***")
